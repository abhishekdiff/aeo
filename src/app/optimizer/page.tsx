...
Compared to traditional CRMs like Competitor A, [Your Brand] offers native intent data integration and AI-driven account prioritization. Unlike point solutions, it provides end-to-end visibility from first touch to closed deal.

### Frequently Asked Questions

**What types of companies use [Your Brand]?**
Mid-market and enterprise B2B companies, particularly in SaaS, financial services, and professional services, rely on [Your Brand] for revenue operations.

**How does [Your Brand] pricing work?**
[Your Brand] offers tiered pricing starting at $X/month, with custom enterprise plans. All plans include core CRM, automation, and analytics features.`;
  ...
  return (
    <div className="relative w-24 h-24 flex items-center justify-center">
      <svg className="absolute inset-0 -rotate-90" width="96" height="96" viewBox="0 0 96 96">
        <circle cx="48" cy="48" r={r} fill="none" stroke="rgba(99,102,241,0.08)" strokeWidth="8" />
        <circle
    ...
    <div className="p-8 min-h-screen grid-pattern" style={{ background: "transparent" }}>
      ...
      <div className="flex items-center justify-between mb-8 animate-fade-in-up">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-semibold" style={{ color: "#e2e8f0" }}>Content Optimizer</h1>
          </div>
      ...
      <div className="grid grid-cols-2 gap-5">
          ...
          <div className="glass-card rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold tracking-widest" style={{ color: "#484f68" }}>YOUR CONTENT</span>
              </div>
              <button
                onClick={() => setContent(SAMPLE_CONTENT)}
                className="flex items-center gap-1.5 text-xs transition-all px-2.5 py-1 rounded-lg"
                style={{ color: "#818cf8", border: "1px solid rgba(99,102,241,0.15)" }}
              >
            ...
            <div className="flex items-center justify-between mt-3">
              <div className="flex items-center gap-3">
                <span className="mono text-xs" style={{ color: "#343650" }}>{wordCount} words</span>
                {wordCount > 0 && (
                  <div
                ...
                {wordCount > 0 && wordCount < 300 && (
                  <span className="text-xs" style={{ color: "#484f68" }}>target: 300+</span>
                )}
              </div>
              <button
        ...
        <div className="space-y-4 animate-fade-in-up-2">
          {!result && !isAnalyzing && (
            <div
              className="glass-card rounded-xl p-14 flex flex-col items-center justify-center text-center"
            ...
            >
              ...
              >
                <Zap className="w-7 h-7" style={{ color: "#484f68" }} />
              </div>
              <p className="text-sm" style={{ color: "#343650" }}>
                Paste content and click Analyze
              </p>
              <p className="text-xs mt-1" style={{ color: "#2a2d3d" }}>
                Get your AEO readiness score & recommendations
              </p>
            </div>
          )}
          ...
          {isAnalyzing && (
            <div
              className="glass-card rounded-xl p-14 flex flex-col items-center justify-center"
              style={{ minHeight: "360px" }}
            >
              <div
              ...
              <p className="text-sm" style={{ color: "#6b7280" }}>Analyzing content...</p>
            </div>
          )}
            ...
            <>
              ...
              <div className="glass-card rounded-xl p-6">
                <div className="flex items-center gap-5 mb-5">
                  ...
                  <div>
                    <div className="text-xs font-semibold tracking-widest mb-1" style={{ color: "#484f68" }}>
                      AEO READINESS SCORE
                    </div>
                    ...
                    <div className="mt-2 text-xs" style={{ color: "#484f68" }}>
                  ...
                  {result.checks.map((check, i) => (
                    <div key={i} className="flex items-start gap-2.5">
                      {check.passed ? (
                        ...
                        <XCircle className="w-3.5 h-3.5 mt-0.5 flex-shrink-0" style={{ color: "#484f68" }} />
                      )}
                      <div>
                        <p className="text-xs" style={{ color: check.passed ? "#9ca3af" : "#484f68" }}>{check.label}</p>
                        {!check.passed && (
                          <p className="text-[10px] mt-0.5" style={{ color: "#343650" }}>{check.tip}</p>
                        )}
                      </div>
                    </div>
                  ))}
              ...
              {result.suggestions.length > 0 && (
                <div className="glass-card rounded-xl p-5">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-xs font-semibold tracking-widest" style={{ color: "#484f68" }}>
                      IMPROVEMENTS
                    </span>
                  </div>
              ...
              <div className="glass-card rounded-xl p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    onClick={() => handleCopy(result.optimizedSnippet)}
                ...
                <pre
                  className="text-xs leading-relaxed overflow-auto max-h-60 p-4 rounded-lg whitespace-pre-wrap"
                  style={{
                    background: "rgba(255,255,255,0.02)",
