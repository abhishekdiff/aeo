...
const sentimentStyle = (s: string) => ({
  positive: { bg: "rgba(16,185,129,0.1)", color: "#34d399", border: "rgba(16,185,129,0.2)" },
  neutral: { bg: "rgba(107,114,128,0.1)", color: "#9ca3af", border: "rgba(107,114,128,0.2)" },
  negative: { bg: "rgba(239,68,68,0.1)", color: "#f87171", border: "rgba(239,68,68,0.2)" },
}[s] || { bg: "rgba(107,114,128,0.1)", color: "#9ca3af", border: "rgba(107,114,128,0.2)" });
    ...
    <div className="p-8 min-h-screen grid-pattern" style={{ background: "transparent" }}>
      ...
      <div className="flex items-center justify-between mb-8 animate-fade-in-up">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-semibold" style={{ color: "#e2e8f0" }}>Brand Monitoring</h1>
          </div>
        ...
        {[
          ...
          <div key={s.label} className="glass-card rounded-xl p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[10px] tracking-widest font-semibold" style={{ color: "#343650" }}>
                {s.label.toUpperCase()}
              </span>
            </div>
      ...
      <div className="glass-card rounded-xl p-6 mb-6 animate-fade-in-up-2">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={sentimentTrend} barSize={18}>
            ...
            <Bar dataKey="neutral" stackId="a" fill="#374151" name="Neutral" />
      ...
      <div className="flex items-center gap-4 mb-5 animate-fade-in-up-3">
        <div className="flex items-center gap-1.5">
          <span className="text-[10px] tracking-widest font-semibold" style={{ color: "#343650" }}>ENGINE</span>
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-[10px] tracking-widest font-semibold" style={{ color: "#343650" }}>SENTIMENT</span>
          <div className="flex gap-1">
            {SENTIMENTS.map((s) => (
              <button
                key={s}
        ...
        {filtered.map((m, i) => {
          ...
          return (
            <div
              ...
              style={{
                background: isExpanded ? "rgba(13,14,26,0.9)" : "rgba(7,8,15,0.6)",
                border: `1px solid ${isExpanded ? "rgba(99,102,241,0.15)" : "rgba(99,102,241,0.06)"}`,
              }}
            ...
            >
              <div className="flex items-center justify-between px-5 py-3.5">
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{
                      background: m.mentioned ? "#10b981" : "#ef4444",
                      boxShadow: `0 0 6px ${m.mentioned ? "#10b98180" : "#ef444480"}`,
                    }}
                  />
                  <div>
                    <p className="text-sm" style={{ color: "#c9d1e0" }}>{m.query}</p>
                    <div className="flex items-center gap-2 mt-0.5">
                      <span
                        className="text-[10px] font-medium px-1.5 py-0.5 rounded"
                        style={{
                          background: `${engineColors[m.engine] || "#6b7280"}12`,
                          color: engineColors[m.engine] || "#6b7280",
                        }}
                      >
                        {m.engine}
                      </span>
                      <span className="text-[10px]" style={{ color: "#343650" }}>{m.date}</span>
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span
                    ...
                    style={{
                      ...
                      color: m.mentioned ? "#34d399" : "#f87171",
                      border: `1px solid ${m.mentioned ? "rgba(16,185,129,0.2)" : "rgba(239,68,68,0.2)"}`,
                    }}
                  >
              ...
              {isExpanded && (
                ...
                >
                  <p className="text-[10px] mb-2 tracking-widest font-semibold" style={{ color: "#343650" }}>
                    AI RESPONSE SNIPPET
                  </p>
                  <p className="text-sm leading-relaxed" style={{ color: "#9ca3af" }}>{m.snippet}</p>
                </div>
              )}
            </div>
          );
